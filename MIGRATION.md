...
- Mermaid support: first-class support for [Mermaid](https://mermaid.js.org/) - a JavaScript-based diagram and charting tool supported by GitHub - has been added to the theme. **This feature is opt-in.** See the main documentation for [Configuration](https://just-the-docs.github.io/just-the-docs/docs/customization/#mermaid-diagrams) and [Code](https://just-the-docs.github.io/just-the-docs/docs/ui-components/code/#mermaid-diagram-code-blocks) for more.
...
We've added several custom `_includes` to provide users with more customization options for different site elements. We've also added a section on [Configuration](https://just-the-docs.github.io/just-the-docs/docs/customization/#override-includes) to outline these.
...
For more, see [Custom layouts and includes](https://just-the-docs.github.io/just-the-docs/docs/customization/#custom-layouts-and-includes). PR: [#1058].
...
In addition to customizing the search placeholder, we've also added the ability to provide custom content to the search index. for more, see [Custom content for search index](https://just-the-docs.github.io/just-the-docs/docs/search/#custom-content-for-search-index). PR: [#1068].
...
- Links wrap. PR: [#905]
- Callouts: a new component similar to alerts or banners. See [UI Components - Callouts](https://just-the-docs.github.io/just-the-docs/docs/ui-components/callouts/). PR: [#466]
